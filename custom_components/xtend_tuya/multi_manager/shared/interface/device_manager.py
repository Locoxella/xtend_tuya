...
class XTDeviceManagerInterface(
    ...
    XTDeviceManagerAPIInterface,
    XTDeviceManagerIPCameraInterface,
    XTDeviceManagerInfraRedInterface,
    XTDeviceManagerDeviceManagementInterface,
    XTDeviceManagerMQTTManagementInterface,
    XTDeviceManagerLockManagementInterface,
    ABC,
):
    @abstractmethod
